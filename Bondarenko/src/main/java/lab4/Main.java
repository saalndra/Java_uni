...
import lab4.services.GroupService;
...
public class Main {
    public static void main(String[] args) {
        // Створюємо студентів
        Student student1 = new Student("Іван", "Петров", "2001-05-14", "12345", 312);
        Student student2 = new Student("Олена", "Коваль", "2000-08-20", "12346", 312);
        Student student3 = new Student("Олександр", "Петров", "1999-01-30", "12347", 302);
        Student student4 = new Student("Марія", "Коваль", "2001-12-25", "12348", 302);
